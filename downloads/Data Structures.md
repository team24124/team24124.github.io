...
You may have noticed that for groups of related data you don't really have a way of organizing them in a neat, useful way. Right now you're kind of just juggling variables, giving them redundant names like `name4` or `result3`. In cases like this where a bunch of data would benefit from being organized together, you will be using *data structures.*
...
- Data structures come in various different forms, all of which have their own uses as well as drawbacks. <!-- .element: class="fragment" data-fragment-index="1" -->
- In  <!-- .element: class="fragment" data-fragment-index="2" --> *Java*, the main ones you wanna know are  <!-- .element: class="fragment" data-fragment-index="2" --> **Arrays, Lists, and HashMaps.** <!-- .element: class="fragment" data-fragment-index="2" -->

I'm just gonna teach you the basics;<!-- .element: class="fragment" data-fragment-index="3" --> **Arrays, ArrayLists, and LinkedLists.**<!-- .element: class="fragment" data-fragment-index="3" --> This is mainly because I don't want to overwhelm you with information, and because I want this to be a crash course<!-- .element: class="fragment" data-fragment-index="3" --> in *data structures,* <!-- .element: class="fragment" data-fragment-index="3" -->not *data structures you can use in Java.* <!-- .element: class="fragment" data-fragment-index="3" -->

All good?<!-- .element: class="fragment" data-fragment-index="4" --> **Lets get started!** <!-- .element: class="fragment" data-fragment-index="4" -->
...
### What are the specifics of arrays? <!-- .element: class="fragment" data-fragment-index="1" -->

An array is really just an arbitrary number of values put together into one. 

- Each value has an index. <!-- .element: class="fragment" data-fragment-index="2" -->
- Each value must be of the same type <!-- .element: class="fragment" data-fragment-index="3" -->
- The amount of values cannot change from declaration <!-- .element: class="fragment" data-fragment-index="4" -->
...
![Array visual representation](../array-visual-representation.png)
*Note how the numbers count up from zero, this is how data structures index.* **They always start from zero.**

## Let's take a look at how one looks in code <!-- .element: class="fragment" data-fragment-index="1" -->
---
...
Let's say I want to access each element of an array and modify them in some way. How would I go about doing this? <!-- .element: class="fragment" data-fragment-index="1" -->
Well, I would need to make a loop which let my apply the changes I needed to <!-- .element: class="fragment" data-fragment-index="2" --> *for* every index. <!-- .element: class="fragment" data-fragment-index="2" -->
...
See, what we're doing is using the number kept track of in the for loop to keep track of our array. <!-- .element: class="fragment" data-fragment-index="3" --> *Note how it ends before the length of the array. This because the last element will always be called the length - 1, all because we start counting from 0 instead of 1.* <!-- .element: class="fragment" data-fragment-index="3" -->
...
Have you noticed something which I've been avoiding doing? <!-- .element: class= "fragment" data-fragment-index="1" -->
...
// Other stuff
```
Just printing out the array itself to the console. Theoretically, this shouldn't do anything weird... Right? <!-- .element: class="fragment" data-fragment-index="2" -->
...
Oh dear. <!-- .element: class="fragment" data-fragment-index="4" -->
...
Okay great, but why did *that* program print out a <!-- .element: class="fragment" data-fragment-index="1" --> **memory address** of all things? <!-- .element: class="fragment" data-fragment-index="1" -->
Well, it has to do with two things: <!-- .element: class="fragment" data-fragment-index="2" -->
1. That arrays aren't  <!-- .element: class="fragment" data-fragment-index="3" -->*primitive data types.*  <!-- .element: class="fragment" data-fragment-index="3" -->They are what is known as *objects.* <!-- .element: class="fragment" data-fragment-index="3" --> You'll know what this means later when we talk about *Object Oriented Programming* <!-- .element: class="fragment" data-fragment-index="3" -->
2. That the variable which we use to refer to an array is what is known as a  <!-- .element: class="fragment" data-fragment-index="4" -->*pointer.* <!-- .element: class="fragment" data-fragment-index="4" -->  If you've worked with lower level languages, you'll know what this means. In short, **it is a variable which points to a memory address.** <!-- .element: class="fragment" data-fragment-index="4" -->
...
For example: <!-- .element: class="fragment" data-fragment-index="1" -->
``` java
// other stuff
...
This can get a little confusing, though. Especially when you write methods that take an array as a parameter. <!-- .element: class="fragment" data-fragment-index="1" -->
...
![Array Memory Visualization](../array-memory-visualization.png)
...
## So, let's get started with ArrayLists! <!-- .element: class="fragment" data-fragment-index="1" -->
...
The first line imports the <!-- .element: class="fragment" data-fragment-index="1" -->*ArrayList* class (You'll understand this better when we go over Object Oriented Programming). <!-- .element: class="fragment" data-fragment-index="1" -->

The actual creation of the arraylist is <!-- .element: class="fragment" data-fragment-index="2" --> *different* than creating an array, but it's pretty straightforward. Now, for initializing one with elements, you need to use a bit of a workaround in the Arrays class. This isn't necessary though. <!-- .element: class="fragment" data-fragment-index="2" -->
...
- Websites like <!-- .element: class="fragment" data-fragment-index="1" --> *W3Schools* <!-- .element: class="fragment" data-fragment-index="1" -->and *GeeksForGeeks* which focus on digestible documentation <!-- .element: class="fragment" data-fragment-index="1" -->
- Websites like <!-- .element: class="fragment" data-fragment-index="2" --> *StackOverflow*  which are forums that focus on programming. If you have a question about anything in programming, chances are you'll find it here. <!-- .element: class="fragment" data-fragment-index="2" -->
- Official Java documentation. This is less recommended because it is a little hard to read if you don't know exactly what you're looking for. <!-- .element: class="fragment" data-fragment-index="3" -->
